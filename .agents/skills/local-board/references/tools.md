...
- Identity and discovery: `whoami`, `list_actors`, `list_projects`, `get_project_context`, `list_workflows`, `list_labels`, `list_milestones`.
...
- Discussion and execution: `add_comment`, `update_comment`, `delete_comment`, `add_checklist_item`, `update_checklist_item`, `delete_checklist_item`.
...
- Administration: `create_project`, `create_milestone`, `create_label`, `set_workflow`, `list_activity`, `update_activity`, `delete_activity`.
