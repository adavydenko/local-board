...
Coverage is branch-aware, lists missing lines, and enforces a 70% minimum. This
baseline covers the domain and transport paths while leaving platform-specific
CLI error handling out of the required path. Browser tests are isolated because
they download a browser:
